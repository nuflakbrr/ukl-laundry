...
<html lang="en">
<head>
    <title>UKL Laundry | Naufal Akbar Nugroho</title>
    <meta charset="UTF-8">
        ...
        <section class="bg-gray-900 body-font">
            <div class="container px-5 py-24 mx-auto">
                <div class="text-center mb-20">
                    <h1 class="sm:text-3xl text-2xl font-medium text-center title-font text-white mb-4">Selamat Datang di Laundry Online</h1>
                    <p class="text-gray-400 leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">Untuk menggunakan fitur selengkapnya, silakan pilih menu dibawah ini!</p>
                </div>
