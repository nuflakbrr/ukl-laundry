...
<div x-data="setup()" :class="{ 'dark': isDark }">
    <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black">
      ...
      <div class="h-full ml-14 mt-14 md:ml-64 print:-mt-40 print:mx-auto">
        ...
        <div class="relative py-3 sm:max-w-xl sm:mx-auto">
            ...
            <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                <div class="max-w-md mx-auto">
                    <div>
                        <h1 class="text-2xl font-semibold print:hidden">Silakan Ubah Data Transaksi!</h1>
                        ...
                        <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                            ...
                            <form action="../utils/process-update-employee.php" method="post">
                                ...
                                <div class="relative mt-5 print:hidden">
                                    <button type="submit" class="w-full bg-blue-600 text-white text-md rounded-md px-2 py-1 hover:bg-blue-700">Ubah Data Akun</button>
                                </div>
                            </form>
                            <div class="relative mt-5 print:hidden">
